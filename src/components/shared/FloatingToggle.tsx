...
export default function FloatingToggle(): React.JSX.Element {
  ...
  return (
    <button
      ...
      className={`flex items-center justify-center h-14 w-14 rounded-full text-black bg-gradient-to-r from-primary to-secondary absolute bottom-6 right-6 z-[999] shadow-sm shadow-accent ${
